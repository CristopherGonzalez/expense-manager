...
<table class="table table-bordered table-hover">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php if($debt->document_number!=null){echo $debt->document_number;}else{ echo "<center>----</center>"; }  ?></td>
			<td><?php if($debt->pagado!=null && $debt->pagado){echo "<span style='color: #00a65a;'>Pagado</span>"; }else{ echo "<span>Impago</span>"; }  ?></td>
			<td class="text-right">
