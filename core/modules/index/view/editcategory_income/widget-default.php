                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <span>
                                        <?php
                                        $lblchange_log = new lblChangeLog($category_income->id, "category_income");
                                        echo $lblchange_log->renderLabel();
                                        $modal_content = new Modal("Listado de Cambios", "frmcategory_income", UserData::getById($_SESSION['user_id']));
