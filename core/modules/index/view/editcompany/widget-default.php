                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" required class="form-control " name="direccion" id="direccion" placeholder="Direccion" value="<?php echo $company->direccion; ?>">
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label for="telefono" class="control-label">Telefono</label>
                                    <input type="number" required class="form-control " name="telefono" id="telefono" placeholder="Telefono" value="<?php echo $company->telefono; ?>">
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <?php
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <label for="status">
                                        <input type="checkbox" id="status" name="status" <?php if ($company->status == 2) {
                                                                                                echo "checked";
                                                                                            } ?>> Inhabilitado
                                    </label>
                                </div>
                            ...
                            <div class="box-footer text-right">
                                <label style="color:#999; font-weight:normal;">Registrado por <?php $creator_user = UserData::getById(1);
                                                                                                echo $creator_user->name  ?> el <?php echo date("Y-d-m", strtotime($company->created_at));  ?></label>
