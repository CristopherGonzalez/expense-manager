                    ...
                    <form role="form" method="post" name="upd" id="upd"><!-- form start -->
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="password" name="password" placeholder="Contraseña: " value="<?php echo $user->password; ?>">
                            </div>
                            <div class="form-group">
                                <label for="disabled" class="control-label">
                                    <input type="checkbox" id="disabled" name="disabled" <?php if($user->status != 3){echo "checked";} ?> > Inhabilitar
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="is_admin" class="control-label">
                                    <input type="checkbox" id="is_admin" name="is_admin" <?php if($user->is_admin == "1"){echo "checked";} ?> > Administrador
                                </label>
                            </div>
                            <!-- mod id -->
