...
<head>
    ...
    <link rel="icon" type="image/jpg" href="res/images/logo_MRC.jpg" />
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="res/images/users/<?php echo $user_session->profile_pic ?>" class="user-image"
                                    alt="User Image">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <?php
                                        ...
                                        $date_user = $d . "-" . $m . "-" . $Y;
                                        ?>
                                    <img src="res/images/users/<?php echo $user_session->profile_pic ?>"
                                        class="img-circle" alt="User Image">
                                    <p><?php echo $user_session->name ?>
                                        <!-- - (<?php echo $user_session->email ?>) --><small>Miembro desde:
                                            <?php echo $date_user; ?></small>
                                    </p>
                                </li>
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="./?view=profile" class="btn btn-default btn-flat"><i
                                                class="glyphicon glyphicon-user"></i> Mi Cuenta</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="./?action=logout" class="btn btn-default btn-flat"><i
                                                class="glyphicon glyphicon-off"></i> Cerrar Sesión</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
            ...
            <section class="sidebar">
                <div class="user-panel">
                    <div class="pull-left image">
                        <img src="res/images/users/<?php echo $user_session->profile_pic ?>" class="img-circle"
                            alt="User Image">
                    </div>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="header">ADMINISTRACION 4.0</li>
                    ...
                    <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'category_expense' or $_GET['view'] == 'editcategory_expense') {
                        ...
                        <a href=""><i class="fa fa-th"></i> <span>Categorias</span></a>
                        <ul id="TypesReports">
                            <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'category_income' or $_GET['view'] == 'editcategory_income') {
                                                    echo "active";
                                                } ?>">
                                <a href="?view=category_income"> <span>Ingresos</span></a>
                            </li>
                            <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'category_expense' or $_GET['view'] == 'editcategory_expense') {
                                                    echo "active";
                                                } ?>">
                                <a href="?view=category_expense"><span>Egresos</span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'reports') {
                        ...
                        <ul id="TypesReports">
                            <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'reports') {
                                ...
                                <a href="?view=reports"><span>Gestión</span></a>
                            </li>
                            <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'paymentreports') {
                                                    echo "active";
                                                } ?>">
                                <a href="?view=paymentreports"><span>Pagos</span></a>
                            </li>
                            <li class="<?php if (isset($_GET['view']) and $_GET['view'] == 'expirationreports') {
                                                    echo "active";
                                                } ?>">
                                <a href="?view=expirationreports"><span>Vencimientos</span></a>
                            </li>
                        </ul>
                    </li>
