...
if(isset($_SESSION["user_id"])):
    ...
    $user_data=UserData::getById($_SESSION["user_id"]);
?>
                        ...
                        <form role="form" method="post" name="upd" id="upd"><!-- form start -->
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="imagefile" type="file" class="form-control" id="imagefile" onchange="upload_image(<?php echo $_SESSION['user_id']; ?>);">
                                </div>
                                <div class="form-group">
                                    <label for="theme">Tema:</label>
                                    <select name="skin" class="form-control select2" id="skin" required>
                                        <?php
                                            $skins=SkinsData::getAll();
                                            foreach($skins as $skin): 
                                        ?>
                                        <option <?php if($user_data->skin==$skin->id){echo "selected";} ?> value="<?php echo $skin->id ?>"><?php echo $skin->name ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>                   
                            </div><!-- /.box-body -->
