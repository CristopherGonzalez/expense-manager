                    ...
                    <form role="form" method="post" name="upd" id="upd">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        ...
                                        <input type="date" required class="form-control" id="date_expires" name="date_expires" placeholder="Fecha " value="<?php echo date('Y-m-d',  strtotime($income->fecha_vence));  ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <label for="date">Numero Documento: </label>
                                        <input type="text" class="form-control" id="document_number" name="document_number" placeholder="Numero Documento" value="<?php echo $income->document_number; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <select class="form-control  style=" width: 100%" name="entity" id="entity" onchange="change_entity('type_income','category');">
                                            ...
                                            ?>
                                                <option <?php if ($income->entidad == $entity->id) {
                                                            echo "selected";
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <select class="form-control  style=" width: 100%" name="category" id="category">
                                            ...
                                            ?>
                                                <option <?php if ($income->category_id == $cat->id) {
                                                            echo "selected";
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <select class="form-control  style=" width: 100%" name="type_income" id="type_income">
                                            ...
                                            ?>
                                                <option <?php if ($income->tipo == $type->id) {
                                                            echo "selected";
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group justify-content-between">
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <div class="form-group">
                                                    <input type="checkbox" id="paid_out" name="paid_out" class="col-md-1 col-sm-1 col-xs-1" <?php if ($income->pagado) {
                                                                                                                                                echo "checked";
                                                    ...
                                                    <div class="col-md-9 col-sm-7 col-xs-7">
                                                        <div id="div_pay_with" style="display:none;" class="row">
                                                            ...
                                                            <input type="text" class="col-md-9 col-sm-9 col-xs-9" style="float:right;" name="pay_with" id="pay_with" placeholder="Tipo de Pago" value="<?php echo $income->pagado_con; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <span style="float:right;">
                                                    ...
                                                    $modal_content = new Modal("Listado de Cambios", "frmincome", UserData::getById($_SESSION['user_id']));
                            ...
                            <div class="box-footer text-right">
                                <label style="color:#999; font-weight:normal;">Registrado por <?php $creator_user = UserData::getById($income->user_id);
                                                                                                echo $creator_user->name  ?> el <?php echo $income->created_at;  ?></label>
                                <span style="margin-left:10px;">
                                    <a href="./?view=income" class="btn btn-default">Volver</a>
