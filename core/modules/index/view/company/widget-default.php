                    ...
                    <div class="form-group">
                        ...
                        <div class=" pull-right">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required class="form-control " name="direccion" id="direccion" placeholder="Direccion">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" required class="form-control " name="telefono" id="telefono" placeholder="Telefono" min="1000000" max="999999999999">
                                </div>
                            </div>
                            <div class="form-group">
                                <?php
