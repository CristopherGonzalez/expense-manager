                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="origin" id="origin" onchange="change_origin(this);"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" id="type" onchange="change_categories(this);"
                                    required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name_entity" name="name_entity"
                                    placeholder="Nombre" value="<?php echo $entity->name; ?>">
                            </div>
                            <div class="form-group">
                                <input type="checkbox" id="active" name="active"
                                    <?php echo isset($entity->active) && $entity->active == 1 ? "checked" : ""; ?>>
                            ...
                            <!-- mod id -->
                            <input type="hidden" required class="form-control" id="category_id" name="category_id"
                                value="<?php echo $entity->category_id; ?>">
                            <input type="hidden" required class="form-control" id="mod_id" name="mod_id"
                                value="<?php echo $entity->id; ?>">
                        </div><!-- /.box-body -->
                        <div class="box-footer text-right">
                            <label style="color:#999; font-weight:normal;">Registrado por
                                <?php $creator_user = UserData::getById($entity->user_id);
                                    echo $creator_user->name  ?>
                                el <?php echo $entity->created_at;  ?></label>
...
$("#upd").submit(function(event) {
    ...
    var category = (category_expense > 0 || category_expense > "") ? category_expense : (category_income > 0 ||
