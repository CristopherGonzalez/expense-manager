    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Historial Usuarios</h3>
...
<script>
    function eliminar(id){
        if(confirm('Esta acción  eliminará de forma permanente al Usuario \n\n Desea continuar?')){
            var page=1;
            //Se cambia para mantener estandar de envio de parametros
            var name = $("#f_name").val();
            var per_page=$("#per_page").val();
            var parametros = {"page":page,'f_name':name,'per_page':per_page, 'id':id};
