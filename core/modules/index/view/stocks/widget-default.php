...
?>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        <!-- Se agregan nuevos filtros de mes, año, tipo de Valores-->
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class=" pull-right">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="form-horizontal" role="form" method="post" id="add_register" name="add_register" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <?php
                                                    $type_stock_select = new SelectList("type_stock", "Tipo", $types);
                                                    $type_stock_select->tag = "disabled";
                                                    echo $type_stock_select->renderLabel('col-sm-2');
                                                    ?>
                                                    <div class="col-sm-10">
                                                        <?php echo $type_stock_select->render(); ?>
                                                    </div>
                                                </div>
                            ...
                            <?php $stocks_data = ExpensesData::getAllCount($_SESSION['company_id']);
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Historial Valores</h3>
    ...
    <script>
        ...
        async function exportExcel(page) {
            ...
            await $.get({
                ...
                success: function(data) {
                    ...
                    hiddenElement.download = `Valores_${today}.csv`;
                    hiddenElement.click();
                    $("#loader").html("");
                }
        ...
        function eliminar(id) {
            if (confirm('Esta acción  eliminará de forma permanente el valor \n\n Desea continuar?')) {
