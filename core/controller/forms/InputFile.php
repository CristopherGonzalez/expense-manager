...
class InputFile{
	...
	public function renderImage($class_css="",$alt=""){ 
		$html = "<div class=".$class_css.">";
        $html.= "<img src=".$this->file." alt=".$alt." class='img-thumbnail' id='".$this->name."_image' height='60' width='75' ></div>";
        return $html;
	}
	public function renderImageCam($class_css=""){
		return "<input type='file' class='form-control' capture=camera accept=".$this->type." id='".$this->name."_cam' name='".$this->name."_cam' ".$this->funjs.">";
	}
}